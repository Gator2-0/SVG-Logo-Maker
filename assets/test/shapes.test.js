...
describe('Shapes', ()=>{
  describe('Square', ()=>{
    ...
    <text x="100" y="100" font-size="50" font-weight="bold" fill="black">test</text>
    </svg>`
  ...
  describe('Circle', ()=>{
    ...
    <text x="50" y="110" font-size="50" font-weight="bold" fill="black">test</text>
    </svg>`
  ...
  describe('Triangle', ()=>{
    ...
    <text x="95" y="150" font-size="50" font-weight="bold" fill="black">test</text>
    </svg>`
